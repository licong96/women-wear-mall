...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .picker
    ...
    .picker-panel
      ...
      bottom: 0
      width: 100%
      height: 7.28rem /* 273/37.5 */
      background: $color-white
      &.picker-move-enter, &.picker-move-leave-active
        transform: translate3d(0, 7.28rem /* 273/37.5 */, 0)
      ...
      .wheel-wrapper
        ...
        .wheel
          flex-fix()
          height: 4.61rem /* 173/37.5 */
          overflow: hidden
          font-size: $fontsize-large
          .wheel-scroll
            padding: 0
            margin-top: 1.81rem /* 68/37.5 */
